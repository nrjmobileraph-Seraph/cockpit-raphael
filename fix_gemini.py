...
if st.session_state.sidebar_state == "collapsed":
    ...
    st.markdown(f"""
        ...
        @media (max-width: 768px) {{
            section[data-testid="stSidebar"] {{ position: fixed !important; width: 100vw !important; min-width: 100vw !important; z-index: 999998 !important; }}
        }}
...
# Remplacer l'ancien bloc sidebar (entre import streamlit et le reste)
src = re.sub(
...
print("OK - sidebar + apostrophes + mobile appliques")
